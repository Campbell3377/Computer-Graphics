...
var vertexColors = [
    ...
    vec4( 1.0, 0.349, 0.56, 1.0 ),  // pinkish red
    vec4( 1.0, 0.84, 0.0, 1.0 ),  // yellow
    vec4( 0.95, 0.529, 0.184, 1.0 ),  // Orange
    vec4( 0.0, 0.0, 1.0, 1.0 ),  // light blue
    vec4( 0.08, 0.698, 1.0, 1.0 ),  // magenta
...
var render = function() {
        ...
        if(vibeRange > 4.0) { direction = false; }
